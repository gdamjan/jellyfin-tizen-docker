...
# Copy built assets
WORKDIR /build
COPY --from=jellyfin-tizen /src/jellyfin-tizen/config.xml ./config.xml
COPY --from=jellyfin-tizen /src/jellyfin-tizen/icon.png ./icon.png
COPY --from=jellyfin-tizen /src/jellyfin-tizen/index.html ./index.html
COPY --from=jellyfin-tizen /src/jellyfin-tizen/tizen.js ./tizen.js
COPY --from=jellyfin-tizen /src/jellyfin-tizen/www/ ./www/
